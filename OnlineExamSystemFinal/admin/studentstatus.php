  ...
  <body id="myBody" onload="my()">
    <div class="page ">
      ...
      <section class="dashboard-header container-fluid p-3 m-0"  style="background: white;">
				...
				<br>
				<?php 
								$res = mysqli_query($conn, "select *from exam_status where activeUser='$studentUser'");
							while ($row=mysqli_fetch_array($res)) {
								
								
				?>
				<h4 class="text-center bg-light " style="  padding:10px; border-radius:25px;"> <?php echo $row['activeUser'] ?></h4> 
				<br>
	...
	<table class="table    table-responsive table-hover   ">
					<tr> 	
						...
						<th  style="width:20%;"> Current Question No </th>
						<th  style="width:20%;"> Current Score </th>
						<th  style="width:50%;"> Passing Per </th>
...
<?php 
								...
								<tr>
									...
									<td  style="width:auto;"> <?php echo $row["activeExam"];?></td> 
									<td  style="width:auto;"> <?php echo $row["questionNO"];?></td> 
									<td  style="width:auto;"> <?php echo $row["score"];?></td> 
									<td  style="width:auto;"> <?php echo $row["passPer"];?></td> 
